 ...
 * @author Thomas Loyd
 */
public class AddOrModifyOutsourcedPartsController{
    ...
    public Label title;
    @FXML
    private Label id, name, inventory, price, max, min, companyName;
    
    // Creates TextFields for input
    @FXML
    private TextField idInput, nameInput, inventoryInput, priceInput, 
                     maxInput, minInput, companyNameInput;
    ...
    private HBox header, idBox, nameBox, inventoryBox, priceBox, 
                 minMaxBox, companyNameBox, footer;
    ...
    private OutsourcedPart part = new OutsourcedPart();
    private boolean okClicked;
    
    // An empty constructor for utility purposes
    public AddOrModifyOutsourcedPartsController(){
    ...
    public void initialize(){
        part = MainScreenController.outPart;
    ...
    private void onSave() {
        ...
        if(isValid()){
            ...
            part.setCompanyName(companyName.getText());
    ...
    private boolean isValid() throws NullPointerException{
        ...
        try{
            ...
            if(inventoryInput.getText() == null || minInput.getText() == null ||
                    ...
                    nameInput.getText() == null || companyNameInput.getText() == null){
                sendAlert("part");
                return false;
            }
            // Tests if the text fields are empty
               ...
               nameInput.getText().isEmpty() || companyNameInput.getText().isEmpty()){
                sendAlert("part");
                return false;
            }
            // Tests if only blank space was entered
                    ...
                    nameInput.getText().trim().equals("") || companyNameInput.getText().trim().equals("")){
                sendAlert("part");
                return false;
            }
            else{
                ...
                // Tests if the minimum is greater than the minimum
                if(tempMin > tempMax){
                    sendAlert("minmax");
                    return false;
                }
